...
final class OnboardingController
{
    ...
    private function identity(Request$r,int$userId):array
    {
        ...
        if(!in_array($role,['Proprietario','Socio','Administrador','Gerente','Veterinario','Recepcionista','Groomer','Auxiliar veterinario','Financeiro','Estoque','Outra funcao'],true))throw new \RuntimeException('Selecione sua funcao no estabelecimento.');
